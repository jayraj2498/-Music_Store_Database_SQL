...
-- Q1 who is the senoir most employe based on job title ?
...
-- Q3 what aer the top 3 values from total invoice 
...
select customer.customer_id, first_name, last_name , sum(invoice.total) as total_sum
from customer 
inner join invoice
